...
function viewAllRoles() {
    ...
    connection.query(query, (err, res) => {
        if (err) throw err;
        console.table(res); // used to restart app
        start();
    });
}
...
// This will be Used to add a Manager
function addManager() {
...
//Now adding a function to add employees
...
// this will be used to view people by current manager
...
// Used to view Employees by Department
...
// this is used to update an employee role
